/**
 * Copyright (c) 2012 Anders Ekdahl (http://coffeescripter.com/) Dual licensed
...
(function($) {
	...
	AdGallery.prototype = {
		...
		setupElements : function() {
			...
			this.loader = $('<img class="ad-loader" src="'
		...
		_createImageData : function(thumb_link, image_src) {
			...
			} else if (thumb_img.attr('longdesc')
			...
			} else if (thumb_img.attr('title')
					&& thumb_img.attr('title').length) {
		...
		_getDescription : function(image) {
			...
			if (image.desc.length || image.title.length) {
				...
				if (image.title.length) {
					title = '<strong class="ad-description-title">'
							+ image.title + '</strong>';
				}
				;
				var desc = '';
	...
	AdGallerySlideshow.prototype = {
		...
		create : function() {
			this.start_link = $('<span class="ad-slideshow-start">'
					+ this.settings.start_label + '</span>');
			this.stop_link = $('<span class="ad-slideshow-stop">'
					+ this.settings.stop_label + '</span>');
